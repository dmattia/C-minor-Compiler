all: main.o lex.yy.o register.o scope.o list.o hash_table.o error.o token.o parser.tab.o scannerUtil.o expr.o decl.o type.o stmt.o param_list.o symbol.o
...
debug: main.o lex.yy.o register.o scope.o list.o hash_table.o error.o token.o parser.tab.o scannerUtil.o expr.o decl.o type.o stmt.o param_list.o symbol.o
